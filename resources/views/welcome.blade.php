...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" type="image/png" href="{{ asset('/image/piston.png') }}">
    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-900 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            <!-- @if (Route::has('login'))
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="mt-16">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        <a href="{{ route('organizer') }}" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                <div class="h-20 w-20 flex items-center justify-center rounded-full">
                ...
                <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-left">
                        <div class="flex items-center gap-4">
                            <a href="https://www.google.com/maps/place/R.+Bom+Jesus,+212+-+Juvev%C3%AA,+Curitiba+-+PR,+80035-010/@-25.4110021,-49.2582544,17.3z/data=!4m7!3m6!1s0x94dce425dc39bd75:0x9af6dce34df62eb2!8m2!3d-25.4109838!4d-49.2552044!10e3!16s%2Fg%2F11f3dnd9gz?entry=ttu" class="group inline-flex items-center hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                                Rua Bom Jesus, nº 212, sala 1904 | Juvevê, Curitiba, PR, Brazil | CNPJ 49.446.832/0001-25
                            </a>
                        </div>
                    </div>

                    <div class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                        "Louvado seja o Senhor Deus, nossa rocha e escudo, que nos prepara para a guerra!"
                    </div>
                </div>
            </div>
        </div>
